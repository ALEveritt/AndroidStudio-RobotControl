...
public class BluetoothChatFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mBackwardButton = view.findViewById(R.id.button_backward);
        mForwardButton = view.findViewById(R.id.button_forward);
        mRightButton = view.findViewById(R.id.button_right);
        mLeftButton = view.findViewById(R.id.button_left);
        mHighButton = view.findViewById(R.id.button_high);
        mMediumButton = view.findViewById(R.id.button_medium);
        mLowButton = view.findViewById(R.id.button_high);
    }
